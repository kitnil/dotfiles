{ buildFirefoxXpiAddon, fetchurl, lib, stdenv }:
  {
    ...
    "rocker_gestures" = buildFirefoxXpiAddon {
      pname = "rocker_gestures";
      version = "2.0";
      addonId = "admin@fastaddons.com_RockerGestures";
      url = "https://addons.mozilla.org/firefox/downloads/file/3945562/rocker_gestures-2.0.xpi";
      sha256 = "f164096614f38f9f5aa5d6a892152f929aa9df964b09b5b56c66f6ed2c71e96b";
      meta = with lib;
      {
        homepage = "https://fastaddons.com/";
        description = "Allows you to navigate back and forward with your mouse button clicks (right + left = back). This feature is known from Opera browser.";
        license = licenses.mpl20;
