...

{
  ...
  inputs = {
    ...
    nixpkgs-idea.url =
      "github:wigust/nixpkgs/a98b0d1e6d7bed029844576e8637ce9807600ad2";
    ...
    in {
      ...
      in fold (x: xs: xs // x) { } [
          ...
          alerta = with pkgs-20-03;
            python3Packages.alerta.overrideAttrs (old: {
              patches = [
                (fetchurl {
                  url =
                    "https://raw.githubusercontent.com/kitnil/dotfiles/af9f1d52f78955f482d33b8c113c68728b0619f1/dotfiles/nix/patches/alerta-top-narrow-output.patch";
                  sha256 =
                    "07mwlm5x2ia5k05h8b8i53db0r4qpava1jlj6q96r0204qjmi897";
                })
              ];
            });
        ...
        }
        {
          ...
          python-selenium = with import nixpkgs-phantomjs { inherit system; };
            let
              python3WithSelenium = python3.withPackages (python-packages:
      ...
      nixosModules = {
        ...
        home-manager-google-chrome-stable = import ./modules/services/google-chrome-stable.nix;
