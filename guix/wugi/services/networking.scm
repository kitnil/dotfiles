...
;;; Copyright © 2020, 2022, 2023, 2025 Oleg Pykhalov <go.wigust@gmail.com>
;;;
...
(define-module (wugi services networking)
...
(define (crowdsec-firewall-bouncer-shepherd-service config)
  (list
   (shepherd-service
    ...
    (start #~(make-forkexec-constructor
              (list #$(local-file (string-append %distro-directory "/dot_local/bin/crowdsec-firewall-bouncer")
                                  #:recursive? #t)
