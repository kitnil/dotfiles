...
(define-module (wugi services virtualization)
   ...
   (shepherd-service
    ...
    (start
     #~(make-forkexec-constructor
        (list #$(local-file (string-append %distro-directory "/dot_local/bin/virsh")
                            #:recursive? #t)
    ...
    (stop #~(lambda _
              (begin
                ...
                (invoke
                 #$(local-file (string-append %distro-directory "/dot_local/bin/gpu_reset.sh")
                               #:recursive? #t))))))))
