(define-module (wugi home config guixsd)
  ...
  #:use-module (home services ansible)
  ...
  #:use-module (home services monitoring)
  #:use-module (home services nix)
  #:use-module (home services package-management)
  ...
  #:use-module (home services stumpwm)
  ...
  #:use-module (home services networking)
  #:use-module (home services kubernetes)
  #:use-module (home services majordomo billing2)
