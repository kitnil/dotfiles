(define-module (wugi home services haskell-apps)
...
(define home-greenclip-service
  (simple-service 'greenclip-config
                  ...
                  (list `(".config/greenclip.cfg" ,(local-file (string-append %distro-directory "/dot_config/greenclip.cfg"))))))
...
(define home-ghci-service
  (simple-service 'ghci-config
                  home-files-service-type
                  (list `(".ghci" ,(local-file (string-append %distro-directory "/dot_ghci"))))))
