(define-module (wugi home services gtk)
...
(define home-gtk-service
  (simple-service 'gtk-config
                  ...
                  (list `(".config/gtk-3.0/gtk.css" ,(local-file (string-append %distro-directory "/dot_config/gtk-3.0/gtk.css")))
                        `(".config/gtk-3.0/settings.ini" ,(local-file (string-append %distro-directory "/dot_config/gtk-3.0/settings.ini"))))))
