...
policy.add(policy.suffix(policy.STUB(\"192.168.0.131\"), {todname('home.wugi.info')}))
...
policy.add(policy.suffix(policy.STUB(\"192.168.0.0\"), {todname('download.microsoft.com')}))
policy.add(policy.suffix(policy.STUB(\"192.168.0.0\"), {todname('download.windowsupdate.com')}))
policy.add(policy.suffix(policy.STUB(\"192.168.0.0\"), {todname('mp.microsoft.com')}))
policy.add(policy.suffix(policy.STUB(\"192.168.0.0\"), {todname('ntservicepack.microsoft.com')}))
policy.add(policy.suffix(policy.STUB(\"192.168.0.0\"), {todname('stats.microsoft.com')}))
policy.add(policy.suffix(policy.STUB(\"192.168.0.0\"), {todname('update.microsoft.com')}))
