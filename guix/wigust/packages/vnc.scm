...
(define-public tigervnc-client-1.10.1
...
(define-public tigervnc-server-1.10.1
  (package
    (inherit xorg-server)
    (name "tigervnc-server")
    (version (package-version tigervnc-client-1.10.1))
    (native-inputs
     `(("tigervnc-src" ,(package-source tigervnc-client-1.10.1))
       ("autoconf" ,autoconf)
       ("automake" ,automake)
       ("libtool" ,libtool)
       ("gettext-minimal" ,gettext-minimal)
       ...
       ("perl" ,perl)
       ,@(package-native-inputs tigervnc-client-1.10.1)
       ,@(package-inputs tigervnc-client-1.10.1)
