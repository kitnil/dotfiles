(define-module (wugi etc guix channels current-local-file-pc0)
  #:use-module (guix channels)
  #:export (%channels-current-local-file-pc0))

(define %channels-current-local-file-pc0
  (list (channel
         (name 'guix)
...
%channels-current-local-file-pc0
