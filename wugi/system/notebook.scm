...
(define-module (wugi system notebook)
  #:use-module (gnu)
  ...
  #:use-module (wugi packages audio)
  #:use-module (wugi packages bootloaders)
  #:use-module (wugi packages fonts)
  #:use-module (wugi packages linux)
  #:use-module (wugi packages monitoring)
  #:use-module (wugi packages nfs)
  #:use-module (wugi packages package-management)
  #:use-module (wugi packages terminals)
  #:use-module (wugi packages vpn)
  #:use-module (wugi packages wm)
  #:use-module (wugi packages xfce)
  #:use-module (wugi packages xorg)
  #:use-module (wugi services avahi)
  #:use-module (wugi services backup)
  #:use-module (wugi services dbus)
  #:use-module (wugi services desktop)
  #:use-module (wugi services docker)
  #:use-module (wugi services kubernetes)
  #:use-module (wugi services linux)
  ...
  #:use-module (wugi services sound)
  #:use-module (wugi services ssh)
  #:use-module (wugi services xorg)
