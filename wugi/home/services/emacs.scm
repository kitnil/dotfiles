(define-module (wugi home services emacs)
                     ...
                     #$(program-file
                        ...
                        #~(begin
                            ...
                            (for-each
                             ...
                             `(("emacs"
                                ,#$(local-file (string-append %distro-directory "/dot_emacs")))
                               ("emacs.d/.mc-lists.el"
                                ,#$(local-file (string-append %distro-directory "/private_dot_emacs.d/dot_mc-lists.el"))))))))))

(define home-emacs-service
  (simple-service 'emacs-config
                  home-files-service-type
                  (append (list `(".gnus.el" ,(local-file (string-append %distro-directory "/dot_gnus.el"))))
                          (map (lambda (file-name)
                                 `(,(string-append ".emacs.d/" file-name) ,(local-file (string-append %distro-directory "/private_dot_emacs.d/" file-name))))
                               '("abbrev_defs"
                                 "org-generate.org"
                                 "modules/audio.el"
                                 "modules/blog.el"
