...
(wi-define-magit-status-repo guix (expand-file-name "/home/oleg/src/git.savannah.gnu.org/git/guix"))
...
(with-eval-after-load 'git-auto-commit-mode
  (setq gac-default-message
        #'(lambda (filename)
            (let ((prompt "Generate Git commit message following Changelog style. First commit line should end with a period as a sentence in a format. Each modified file should be described as in example \"* /a/b/c.txt: Add something.\". Without saying what you are doing. Limit is 200 characters. Maximum column width is 78 characters. Do not add \"Fix\" word unless you see diff really fixes something."))
